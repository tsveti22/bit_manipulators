...
def get_transcript(file_name):
    ...
    start_job(
        job_name_simple, f's3://{bucket_name}/{media_object_key}', 'wav', 'en-US',
        transcribe_client)
    ...
    res_transcript = transcript_simple['results']['transcripts'][0]['transcript']
